...
#define IF_NOT_EXIT_HASH               (hash_t) 0x2B0A3AB0BE2229D         // if-not;
#define IF_STAR_HASH                   (hash_t) 0xD4902CD8665E4C6B        // if*
#define IF_EXIT_STAR_HASH              (hash_t) 0x79CAD4A86BDF71DE        // if*;
#define IF_NOT_STAR_HASH               (hash_t) 0x2B0A3A5A8A034E6         // if-not*
#define IF_NOT_EXIT_STAR_HASH          (hash_t) 0xD2F1069BEA3DB030        // if-not*;
