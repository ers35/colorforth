...
#define IF_HASH                        (hash_t) 0x597834                  // if
#define IF_EXIT_HASH                   (hash_t) 0xB887EEF                 // if;
#define IF_NOT_HASH                    (hash_t) 0x653041D01F2             // if-not
#define IF_NOT_EXIT_HASH               (hash_t) 0xD0B387BD406D            // if-not;
#define IF_STAR_HASH                   (hash_t) 0xB887EDE                 // if*
#define IF_EXIT_STAR_HASH              (hash_t) 0x17C985AD9               // if*;
#define IF_NOT_STAR_HASH               (hash_t) 0xD0B387BD405C            // if-not*
#define IF_NOT_EXIT_STAR_HASH          (hash_t) 0x1AE7247F654C17          // if-not*;
